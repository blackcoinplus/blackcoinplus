...
int64 nChainStartTime = 1399327561;
...
const string strMessageMagic = "BlackcoinPlus Signed Message:\n";
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xcf3a3387aeddeb08b4200e32ff18197ee8cfa030bf823fcde2d6cc78e40d6520"));
